...
# and for GPUs without tensor cores, we set the value to 100% to avoid division by zero
if max_tensor > 25.0 and max_tensor < 50.0:
    max_tensor = 50.0
else:
    max_tensor = 100.0
...
total_avg_tensor = total['tensor'] / total_time
print("." * len(units))
print(f"           {'Total':<40} {total['time']:8.2f} {total_dram_bw:8.1f} {total_avg_tensor:8.1f} {total['read']:8.2f} {total['write']:8.2f} {total['l2_read']:8.2f} {total['l2_write']:8.2f} {total['inst']:8.2f}")
